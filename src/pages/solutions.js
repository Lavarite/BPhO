...
export const SolutionsPage = ({isSmallViewport}) => {
  const [isLoading, setIsLoading] = useState(true);
  const file   = `https://bpho.vasylevskyi.net/PDFs/Ray Solutions.pdf`;
      ...
      {isLoading && (
        <div className="absolute inset-0 flex flex-col justify-center items-center bg-gray-50 z-10">
          ...
          <p className="text-gray-500 text-center px-4">
            Please wait while we load the Ray Solutions PDF
          </p>
        </div>
      )}
